...
\begin{document}
	...
	I would like to express my gratitude to my mathematics teacher Mr. Qinglin Xu (徐庆林) for his unrequited guidance and support throughout this research. Mr. Xu's insightful advice on selecting the research topic was invaluable and helped me navigate the initial stages of my work. His constructive feedback on my writing significantly improved the quality and clarity of the paper. Mr. Xu's encouragement and thoughtful suggestions were instrumental in overcoming challenges and refining the direction of this research. His dedication and expertise provided a strong foundation for my work, and I am deeply appreciative of his mentorship and commitment.
	
	\vspace{0.2cm}
	
	I have been studying one of the ocular diseases, retinitis pigmentosa (RP), for about 2 years since my family folks have this genetic disease.  I had decided 3 to 4 directions on researching the RP, including studying the relationship between the genomes of patients and their symptoms, investigating how genetic factors influence the misfolding of RP-related proteins, and modeling retinal structural damage, etc. Due to lack of laboratory environment in our middle school, Mr. Xu suggested me to pivot my focus onto deep learning area, which can be achieved with certain knowledge and appropriate hardware.  After having sufficient discussion with Mr. Xu., I decided to investigate the model for ocular disease diagnosis.
	
	When I began to do the study, the first obstacle was that we could not get enough real clinical data.  We communicated with hospitals and institutions, but it was not easy to get approved by authorities at the level of our study.  Therefore, Mr. Xu suggested I use the data from public database and try to build model and verify its feasibility.  I believe this was a key step to make progress and finally I was able to complete this paper.
	
	Regarding paper writing, Mr. Xu is very experienced and he gave me a lot of suggestions and instructions. I got a lot of help from Mr. Xu when I had difficulties on how to use terminologies, organize the contents and do the background research.  I have been so lucky that I always have Mr. Xu at my side.
	
	\vspace{0.2cm}
	Again, thank you, Mr. Xu, for your unwavering support and for investing your time and effort in helping me complete this paper.
