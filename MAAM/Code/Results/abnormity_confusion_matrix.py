...
def plot_complete_conf_mat(ax, complete_conf_mat, abnormities):
    ...
    ax.set_xticklabels(abnormities)
...
def plot_all_conf_mat():
    ...
    plot_complete_conf_mat(axs[0, 0], o_train_conf_mat, o_abbr_abnormities)
    ...
    plot_complete_conf_mat(axs[0, 1], o_test_conf_mat, o_abbr_abnormities)
    ...
    plot_complete_conf_mat(axs[1, 0], f_train_conf_mat, f_abbr_abnormities)
    ...
    plot_complete_conf_mat(axs[1, 1], f_test_conf_mat, f_abbr_abnormities)
