...
class Setting:
    ...
    def convert_abnormity_to_abbr(self, abnormity: str, type: str) -> str:
        abnormities = self.get_abnormities("OCT Abnormities" if type == "AO" or type == "OCT" else "Fundus Abnormities")
    ...
    def get_testing_rs_name(self, name: str) -> str:
